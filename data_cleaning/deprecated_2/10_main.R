...
# ==============================================================================
# Orchestrator script for processing fresh_data files
...
run_pipeline <- function(save_output = FALSE, output_path = NULL, 
  ...
  # Step 1: Process rayyaan_2.csv
  cat("Processing rayyaan_2.csv...\n")
  rayyaan_wide <- process_rayyaan()
  
  # Step 2: Process Amaani_2.csv
  cat("Processing Amaani_2.csv...\n")
  amaani_wide <- process_amaani()
  
  # Step 3: Load ellie_2.csv
  cat("Loading ellie_2.csv...\n")
